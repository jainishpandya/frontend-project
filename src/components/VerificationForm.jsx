...
function VerificationForm(props) {
    ...
    return (
        <div className='flex flex-col justify-center px-28 w-full h-screen rounded-2xl bg-lightblue mt-4'>
            ...
            <div className='mt-4'>
                <div className='mt-4'>
                    <label className='text-md font-medium text-navyblue'>Verification Code</label>
                    <div className='flex w-full bg-lightblue rounded-xl mt-2'>
                        <input
                            className='bg-white w-full text-navyblue rounded-xl p-4 mx-1'
